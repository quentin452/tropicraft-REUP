...
public class TCEntityRegistry
{
    ...
    public static void init() {
        ...
        registerEntity((Class<? extends Entity>)EntityWallStarfish.class, "WallStarfish", 160, Integer.MAX_VALUE, false);
    }
    ...
    private static void registerEntity(final Class<? extends Entity> entityClass, final String entityName, final int trackingRange, final int updateFrequency, final boolean sendsVelocityUpdates) {
        EntityRegistry.registerModEntity((Class)entityClass, entityName, TCEntityRegistry.entityID++, (Object)Tropicraft.instance, trackingRange, updateFrequency, sendsVelocityUpdates);
    }
