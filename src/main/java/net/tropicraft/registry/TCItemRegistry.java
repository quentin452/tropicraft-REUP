...
public class TCItemRegistry
{
    ...
    static {
        ...
        ashenMask = (ItemTropicraftArmor)new ItemAshenMask(TCItemRegistry.materialMaskArmor, 0, 0, getMaskDisplayNames(), getMaskImageNames()).setCreativeTab(TCCreativeTabRegistry.tabDecorations);
        ...
        shovelEudialyte = (ItemTropicraftTool)new ItemTropicraftShovel(TCItemRegistry.materialEudialyteTools, "shovelEudialyte");
        shovelZircon = (ItemTropicraftTool)new ItemTropicraftShovel(TCItemRegistry.materialZirconTools, "shovelZircon");
        shovelZirconium = (ItemTropicraftTool)new ItemTropicraftShovel(TCItemRegistry.materialZirconiumTools, "shovelZirconium");
        pickaxeEudialyte = (ItemTropicraftTool)new ItemTropicraftPickaxe(TCItemRegistry.materialEudialyteTools, "pickaxeEudialyte");
        pickaxeZircon = (ItemTropicraftTool)new ItemTropicraftPickaxe(TCItemRegistry.materialZirconTools, "pickaxeZircon");
        pickaxeZirconium = (ItemTropicraftTool)new ItemTropicraftPickaxe(TCItemRegistry.materialZirconiumTools, "pickaxeZirconium");
        axeEudialyte = (ItemTropicraftTool)new ItemTropicraftAxe(TCItemRegistry.materialEudialyteTools, "axeEudialyte");
        axeZircon = (ItemTropicraftTool)new ItemTropicraftAxe(TCItemRegistry.materialZirconTools, "axeZircon");
        axeZirconium = (ItemTropicraftTool)new ItemTropicraftAxe(TCItemRegistry.materialZirconiumTools, "axeZirconium");
        ...
        TCItemRegistry.leafBall = new ItemTropicraftLeafballNew().setUnlocalizedName("leaf_green").setCreativeTab(TCCreativeTabRegistry.tabCombat);
        ...
        TCItemRegistry.bambooChute = new ItemBambooChute((Block)TCBlockRegistry.bambooChute).setUnlocalizedName("BambooChute");
        ...
        TCItemRegistry.recordBuriedTreasure = new ItemTropicraftMusicDisk("buriedtreasure", "buriedtreasure", "Punchaface").setUnlocalizedName("Buried Treasure");
        TCItemRegistry.recordEasternIsles = new ItemTropicraftMusicDisk("easternisles", "easternisles", "Frox").setUnlocalizedName("Eastern Isles");
        TCItemRegistry.recordLowTide = new ItemTropicraftMusicDisk("lowtide", "lowtide", "Punchaface").setUnlocalizedName("Low Tide");
        TCItemRegistry.recordSummering = new ItemTropicraftMusicDisk("summering", "summering", "Billy Christiansen").setUnlocalizedName("Summering");
        TCItemRegistry.recordTheTribe = new ItemTropicraftMusicDisk("thetribe", "thetribe", "Emile Van Krieken").setUnlocalizedName("The Tribe");
        TCItemRegistry.recordTradeWinds = new ItemTropicraftMusicDisk("tradewinds", "tradewinds", "Frox").setUnlocalizedName("Trade Winds");
        ...
        TCItemRegistry.tropiFrame = new ItemTCItemFrame((Class)EntityTCItemFrame.class, true).setUnlocalizedName("tropiFrame");
        TCItemRegistry.koaFrame = new ItemTCItemFrame((Class)EntityTCItemFrame.class, false).setUnlocalizedName("koaFrame");
