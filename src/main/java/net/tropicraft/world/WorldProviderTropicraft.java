...
public class WorldProviderTropicraft extends WorldProvider
{
    ...
    protected void registerWorldChunkManager() {
        this.worldChunkMgr = (WorldChunkManager)new WorldChunkManagerTropicraft(this.worldObj.getSeed(), this.terrainType);
    }
    
    public IChunkProvider createChunkGenerator() {
        return (IChunkProvider)new ChunkProviderTropicraft(this.worldObj, this.worldObj.getSeed(), this.worldObj.getWorldInfo().isMapFeaturesEnabled());
    }
