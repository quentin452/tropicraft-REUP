...
public class BiomeGenTropicraft extends BiomeGenBase
{
    ...
    public BiomeGenTropicraft(final int biomeID) {
        ...
        if (biomeID == ConfigBiomes.rainforestMountainsID || biomeID == ConfigBiomes.rainforestHillsID || biomeID == ConfigBiomes.rainforestPlainsID) {
            ...
            this.spawnableMonsterList.add(new BiomeGenBase.SpawnListEntry((Class)EntityTreeFrogYellow.class, 25, 1, 2));
        }
        ...
        this.spawnableWaterCreatureList.add(new BiomeGenBase.SpawnListEntry((Class)EntityTropicalFish.class, 10, 1, 12));
    ...
    public void decorate(final World world, final Random rand, final int x, final int z) {
        ...
        new WorldGenTropicraftFlowers(world, rand, (Block)TCBlockRegistry.flowers, BiomeGenTropicraft.DEFAULT_FLOWER_META).generate(i, this.getTerrainHeightAt(world, i, k), k);
        ...
        if (rand.nextInt(4) == 0) {
            i = this.randCoord(rand, x, 16);
            k = this.randCoord(rand, z, 16);
            new WorldGenTallGrass((Block)Blocks.tallgrass, 1).generate(world, rand, i, this.getTerrainHeightAt(world, i, k), k);
        }
        for (int a = 0; a < 25; ++a) {
    ...
    static {
        ...
        BiomeGenTropicraft.tropicsOcean = new BiomeGenTropicraft(ConfigBiomes.tropicsOceanID).setHeight(new BiomeGenBase.Height(-1.0f, 0.4f)).setTemperatureRainfall(1.5f, 1.25f).setBiomeName("Tropical Ocean");
        BiomeGenTropicraft.tropics = new BiomeGenTropics(ConfigBiomes.tropicsID).setHeight(new BiomeGenBase.Height(0.15f, 0.15f)).setTemperatureRainfall(2.0f, 1.5f).setBiomeName("Tropics");
        BiomeGenTropicraft.rainforestPlains = new BiomeGenRainforest(ConfigBiomes.rainforestPlainsID).setHeight(new BiomeGenBase.Height(0.25f, 0.1f)).setColor(1148975).setTemperatureRainfall(1.5f, 2.0f).setBiomeName("Rainforest Plains");
        BiomeGenTropicraft.rainforestHills = new BiomeGenRainforest(ConfigBiomes.rainforestHillsID).setHeight(new BiomeGenBase.Height(0.45f, 0.425f)).setColor(1148975).setTemperatureRainfall(1.5f, 2.0f).setBiomeName("Rainforest Hills");
        BiomeGenTropicraft.rainforestMountains = new BiomeGenRainforest(ConfigBiomes.rainforestMountainsID).setHeight(new BiomeGenBase.Height(1.0f, 1.2f)).setTemperatureRainfall(1.5f, 2.0f).setBiomeName("Rainforest Mountains");
        BiomeGenTropicraft.islandMountains = new BiomeGenRainforest(ConfigBiomes.islandMountainsID).setHeight(new BiomeGenBase.Height(0.1f, 2.5f)).setTemperatureRainfall(1.5f, 2.0f).setBiomeName("Extreme Rainforest Mountains");
        BiomeGenTropicraft.tropicsRiver = new BiomeGenTropicsRiver(ConfigBiomes.tropicsRiverID).setHeight(new BiomeGenBase.Height(-0.7f, 0.05f)).setTemperatureRainfall(1.5f, 1.25f).setBiomeName("Tropical River");
        BiomeGenTropicraft.tropicsBeach = new BiomeGenTropicsBeach(ConfigBiomes.tropicsBeachID).setHeight(new BiomeGenBase.Height(-0.1f, 0.1f)).setTemperatureRainfall(1.5f, 1.25f).setBiomeName("Tropical Beach");
        BiomeGenTropicraft.tropicsLake = new BiomeGenTropicsOcean(ConfigBiomes.tropicsLakeID).setHeight(new BiomeGenBase.Height(-0.6f, 0.1f)).setTemperatureRainfall(1.5f, 1.5f).setBiomeName("Tropical Lake");
