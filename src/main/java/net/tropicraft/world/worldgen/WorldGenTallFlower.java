...
public class WorldGenTallFlower extends TCGenBase
{
    ...
    public WorldGenTallFlower(final World world, final Random rand, final Block plantBlock, final int plantBottomMeta, final int plantTopMeta) {
        super(world, rand);
    ...
    public boolean generate(final int i, final int j, final int k) {
        for (int l = 0; l < this.FLOWER_TRIES; ++l) {
            ...
            if (this.worldObj.isAirBlock(i2, j2, k2) && this.worldObj.isAirBlock(i2, j2 + 1, k2) && this.plantBlock.canBlockStay(this.worldObj, i2, j2, k2)) {
