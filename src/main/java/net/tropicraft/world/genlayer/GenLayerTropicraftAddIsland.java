...
public class GenLayerTropicraftAddIsland extends GenLayerTropicraft
{
    ...
    public GenLayerTropicraftAddIsland(final long seed, final GenLayerTropicraft parent, final int chance, final int landID) {
        super(seed);
    ...
    public int[] getInts(final int x, final int y, final int width, final int length) {
        ...
        for (int i2 = 0; i2 < length; ++i2) {
            for (int j2 = 0; j2 < width; ++j2) {
                ...
                if (backX != this.landID && forwardX != this.landID && backY != this.landID && forwardY != this.landID && cur != this.landID && this.nextInt(this.chance) == 0) {
