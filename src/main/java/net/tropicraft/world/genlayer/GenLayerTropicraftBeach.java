    ...
    public int[] getInts(final int x, final int y, final int width, final int length) {
        ...
        for (int j = 0; j < length; ++j) {
            for (int i = 0; i < width; ++i) {
                ...
                if (cur == GenLayerTropicraftBeach.oceanID && (forwardX != GenLayerTropicraftBeach.oceanID || backY != GenLayerTropicraftBeach.oceanID || forwardY != GenLayerTropicraftBeach.oceanID || backX != GenLayerTropicraftBeach.oceanID)) {
