...
public class ModelIguana extends ModelBase
{
    ...
    public void setLivingAnimations(final EntityLivingBase entityliving, final float f, final float f1, final float f2) {
        ...
        this.tailMid.setRotationPoint(0.0f - MathHelper.cos(this.tailBase.rotateAngleY + 1.570796f) * 6.0f, 21.5f, 12.0f + MathHelper.sin(this.tailBase.rotateAngleX + 3.14159f) * 6.0f);
        this.tailMid.rotateAngleY = this.tailBase.rotateAngleY + MathHelper.cos(f * 0.6662f) * 0.5f * f1;
        this.miscPart.setRotationPoint(0.0f - MathHelper.cos(this.tailMid.rotateAngleY + 1.570796f) * 6.0f, 21.5f, 18.0f + MathHelper.sin(this.tailMid.rotateAngleX + 3.14159f) * 6.0f);
