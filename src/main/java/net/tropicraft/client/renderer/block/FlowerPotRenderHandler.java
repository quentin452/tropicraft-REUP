...
public class FlowerPotRenderHandler implements ISimpleBlockRenderingHandler
{
    ...
    private void renderFlowerPot(final IBlockAccess world, final int x, final int y, final int z, final BlockTropicraftFlowerPot block, final RenderBlocks rb) {
        ...
        rb.renderFaceYPos((Block)block, (double)x, (double)(y - 0.5f + f5 + 0.1875f), (double)z, rb.getBlockIcon(Blocks.dirt));
        ...
        if (var19 != 0) {
            ...
            if (var19 > 0 && var19 < 17) {
                rb.drawCrossedSquares(this.draw((Block)TCBlockRegistry.flowers, var19 - 1), (double)x, (double)y, (double)z, 0.75f);
            }
            else if (var19 == 17) {
                rb.drawCrossedSquares(this.draw((Block)TCBlockRegistry.tallFlowers, 0), (double)x, (double)y, (double)z, 0.75f);
                rb.drawCrossedSquares(this.draw((Block)TCBlockRegistry.tallFlowers, 1), (double)x, y + 0.75, (double)z, 0.75f);
            }
            else if (var19 == 18) {
                rb.drawCrossedSquares(this.draw((Block)TCBlockRegistry.pineapple, 7), (double)x, (double)y, (double)z, 0.75f);
                rb.drawCrossedSquares(this.draw((Block)TCBlockRegistry.pineapple, 8), (double)x, y + 0.75, (double)z, 0.75f);
            }
            else if (var19 > 18 && var19 < 25) {
                rb.drawCrossedSquares(this.draw((Block)TCBlockRegistry.saplings, var19 - 19), (double)x, (double)y, (double)z, 0.75f);
            }
            else if (var19 >= 25 && var19 < 34) {
                rb.drawCrossedSquares(this.draw((Block)Blocks.red_flower, var19 - 25), (double)x, (double)y, (double)z, 0.75f);
            }
            else if (var19 == 34) {
                rb.drawCrossedSquares(this.draw((Block)Blocks.yellow_flower, var19 - 34), (double)x, (double)y, (double)z, 0.75f);
            }
            tessellator.addTranslation(-f7 / 16.0f, -var20 / 16.0f, -var21 / 16.0f);
        }
    }
