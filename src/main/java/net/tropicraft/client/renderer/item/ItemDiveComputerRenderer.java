...
public class ItemDiveComputerRenderer implements IItemRenderer
{
    ...
    public void renderItem(final IItemRenderer.ItemRenderType type, final ItemStack item, final Object... data) {
        ...
        if (chestplate != null && chestplate.getItem() instanceof ItemScubaChestplateGear) {
            float airRemaining = (float)this.getTagCompound(chestplate).getInteger("AirRemaining");
            final int currentDepth = MathHelper.floor_double(player.posY);
            final int maxDepth = this.getTagCompound(chestplate).getInteger("MaxDepth");
            airRemaining = chestplate.getTagCompound().getFloat("AirContained");
            final int blocksAbove = chestplate.getTagCompound().getInteger("WaterBlocksAbove");
            final int blocksBelow = chestplate.getTagCompound().getInteger("WaterBlocksBelow");
            ...
            final float airTemp = player.worldObj.getBiomeGenForCoords(MathHelper.floor_double(player.posX), MathHelper.floor_double(player.posZ)).temperature;
