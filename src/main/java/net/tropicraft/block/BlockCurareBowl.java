...
public class BlockCurareBowl extends BlockTropicraft implements ITileEntityProvider
{
        ...
        if (bowl != null && !par1World.isRemote) {
            if (!bowl.hasMetMaxNumClicks()) {
                for (int var8 = 0; var8 < bowl.getIngredients().length; ++var8) {
                    final ItemStack var9 = bowl.getIngredientList().get(var8);
                    if (var9 != null) {
                        final float var10 = par1World.rand.nextFloat() * 0.8f + 0.1f;
                        final float var11 = par1World.rand.nextFloat() * 0.8f + 0.1f;
                        final EntityItem item = new EntityItem(par1World, (double)(par2 + var10), (double)(par3 + var10), (double)(par4 + var11), var9);
    ...
    public boolean onBlockActivated(final World world, final int i, final int j, final int k, final EntityPlayer entityplayer, final int doop, final float f1, final float f2, final float f3) {
        if (!world.isRemote && entityplayer.getCurrentEquippedItem() != null && entityplayer.getCurrentEquippedItem().getItem() != null) {
            ...
            else if (entityplayer.getCurrentEquippedItem().getItem() == Item.getItemFromBlock((Block)TCBlockRegistry.flowers)) {
