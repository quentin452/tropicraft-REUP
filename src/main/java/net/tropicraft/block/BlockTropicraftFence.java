...
public class BlockTropicraftFence extends BlockFence
{
    ...
    public BlockTropicraftFence(final String name, final String textureName, final BlockTropicraftFenceGate fenceGate, final Material material) {
        super(name, material);
    ...
    public boolean canConnectFenceTo(final IBlockAccess world, final int x, final int y, final int z) {
        ...
        return block == this || block == TCBlockRegistry.bambooFenceGate || block == TCBlockRegistry.palmFenceGate || (block != null && block.getMaterial().isOpaque() && block.renderAsNormalBlock() && block.getMaterial() != Material.gourd);
    }
