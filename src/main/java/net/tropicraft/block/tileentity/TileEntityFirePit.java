...
public class TileEntityFirePit extends TileEntity
{
    ...
    public void updateEntity() {
        ...
        if (this.worldObj.isRemote) {
            if (this.pm == null) {
                this.pm = new ParticleBehaviors(Vec3.createVectorHelper((double)(this.xCoord + 0.5f), (double)(this.yCoord + 0.5f), (double)(this.zCoord + 0.5f)));
            }
            this.tickAnimate();
        }
    }
    ...
    public void tickAnimate() {
        ...
        for (int i = 0; i < amount; ++i) {
            ...
            final EntityRotFX entityfx = this.pm.spawnNewParticleIconFX(this.worldObj, ParticleRegistry.smoke, this.xCoord + rand.nextDouble(), this.yCoord + 0.2 + rand.nextDouble() * 0.2, this.zCoord + rand.nextDouble(), (rand.nextDouble() - rand.nextDouble()) * speed, 0.03, (rand.nextDouble() - rand.nextDouble()) * speed);
