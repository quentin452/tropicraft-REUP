...
public class TileEntityPurchasePlate extends TileEntity
{
    ...
    public void onClicked(final boolean rightClick) {
        if (rightClick) {
            ...
            final JobTrade job = (JobTrade)this.tradeKoa.getAIAgent().jobMan.getFirstJobByClass((Class)JobTrade.class);
            if (job != null) {
    ...
    public void updateEntity() {
        if (!this.worldObj.isRemote) {
            ...
            if (this.activeTrader != null && !this.activeTrader.getEntityData().hasKey("hasShownTradeToolTip")) {
                if (this.toolTipWaitStartTime == 0L) {
                    ...
                    if (this.worldObj.getWorldTime() < this.toolTipWaitStartTime + endTime) {
                        ...
                        this.showToolTip = false;
                        this.toolTipWaitStartTime = 0L;
                        this.activeTrader.getEntityData().setBoolean("hasShownTradeToolTip", true);
                    }
                }
            }
            else {
