...
public class TileEntityEIHMixer extends TileEntity
{
    ...
    public void emptyMixer() {
        if (this.ingredients[0] != null) {
            final EntityItem item = new EntityItem(this.worldObj, (double)this.xCoord, (double)this.yCoord, (double)this.zCoord, this.ingredients[0]);
            this.worldObj.spawnEntityInWorld((Entity)item);
            this.ingredients[0] = null;
        }
        if (this.ingredients[1] != null) {
            final EntityItem item = new EntityItem(this.worldObj, (double)this.xCoord, (double)this.yCoord, (double)this.zCoord, this.ingredients[1]);
            this.worldObj.spawnEntityInWorld((Entity)item);
            this.ingredients[1] = null;
        }
        this.ticks = 80;
    ...
    public void retrieveResult() {
        EntityItem e = new EntityItem(this.worldObj, (double)this.xCoord, (double)this.yCoord, (double)this.zCoord, this.result);
        this.worldObj.spawnEntityInWorld((Entity)e);
        final ItemStack container1 = this.ingredients[0].getItem().getContainerItem(this.ingredients[0]);
        if (container1 != null) {
            e = new EntityItem(this.worldObj, (double)this.xCoord, (double)this.yCoord, (double)this.zCoord, container1);
            this.worldObj.spawnEntityInWorld((Entity)e);
        }
        final ItemStack container2 = this.ingredients[1].getItem().getContainerItem(this.ingredients[1]);
        if (container2 != null) {
            e = new EntityItem(this.worldObj, (double)this.xCoord, (double)this.yCoord, (double)this.zCoord, container2);
            this.worldObj.spawnEntityInWorld((Entity)e);
        }
        this.ingredients[0] = null;
        this.ingredients[1] = null;
