...
public class BlockTropicraftSapling extends BlockSapling implements IGrowable
{
    ...
    protected boolean canPlaceBlockOn(final Block block) {
        return block == Blocks.grass || block == Blocks.dirt || block == Blocks.farmland || block == Blocks.sand || block == TCBlockRegistry.purifiedSand || block == TCBlockRegistry.mineralSands;
    }
