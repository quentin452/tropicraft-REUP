...
public class BlockFruitLeaves extends BlockLeaves
{
    ...
    public void dropBlockAsItemWithChance(final World par1World, final int x, final int y, final int z, final int meta, final float par6, final int par7) {
    ...
    public IIcon getIcon(final int var1, final int meta) {
        return ((meta & 0x3) == 0x1) ? this.icons[this.field_150127_b][1] : (((meta & 0x3) == 0x3) ? this.icons[this.field_150127_b][3] : (((meta & 0x3) == 0x2) ? this.icons[this.field_150127_b][2] : this.icons[this.field_150127_b][0]));
    }
    ...
    static {
        imageNames = new String[][] { { "leafGrapefruit", "leafLemon", "leafLime", "leafOrange" }, { "leafGrapefruitFast", "leafLemonFast", "leafLimeFast", "leafOrangeFast" } };
