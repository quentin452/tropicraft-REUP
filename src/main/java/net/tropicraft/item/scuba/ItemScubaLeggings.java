...
{
    public ItemScubaLeggings(final ItemArmor.ArmorMaterial material, final ItemScubaGear.ScubaMaterial scubaMaterial, final int renderIndex, final int armorType) {
