...
public class ItemTropicraftColored extends ItemTropicraft
{
    ...
    public String getItemStackDisplayName(final ItemStack itemstack) {
        final String name = ("" + StatCollector.translateToLocal(this.getUnlocalizedName().replace("item.", String.format("item.%s:", "tropicraft")).split(":")[0] + ":" + this.iconString + "_" + ItemDye.field_150923_a[itemstack.getItemDamage()] + ".name")).trim();
        return name;
    }
}
