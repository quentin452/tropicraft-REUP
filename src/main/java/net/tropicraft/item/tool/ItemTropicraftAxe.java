...
public class ItemTropicraftAxe extends ItemTropicraftTool
{
    ...
    static {
        effectiveBlocks = Sets.newHashSet(Blocks.planks, Blocks.bookshelf, Blocks.log, Blocks.log2, (Block)Blocks.chest, Blocks.pumpkin, Blocks.lit_pumpkin, (Block)TCBlockRegistry.logs, (Block)TCBlockRegistry.mahoganyStairs, (Block)TCBlockRegistry.palmFence, (Block)TCBlockRegistry.palmFenceGate, (Block)TCBlockRegistry.palmStairs, (Block)TCBlockRegistry.planks);
    }
}
