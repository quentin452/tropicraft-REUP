...
public class ItemTropicraftShovel extends ItemTropicraftTool
{
    ...
    static {
        blocksEffectiveAgainst = Sets.newHashSet((Object[])new Block[] { (Block)Blocks.grass, Blocks.dirt, (Block)Blocks.sand, Blocks.gravel, Blocks.snow_layer, Blocks.snow, Blocks.clay, Blocks.farmland, Blocks.soul_sand, (Block)Blocks.mycelium });
    }
}
