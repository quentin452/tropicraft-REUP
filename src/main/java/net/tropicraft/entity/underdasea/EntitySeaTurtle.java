...
public class EntitySeaTurtle extends EntityAmphibian
{
    ...
    public void onLivingUpdate() {
        ...
        if (this.onGround && this.getAmphibianAge() >= 1.0f && this.returnToLand && this.worldObj.getBlock((int)this.posX, (int)this.posY - 1, (int)this.posZ).getMaterial() == Material.sand && this.rand.nextInt(600) == 0) {
    ...
    public boolean interact(final EntityPlayer entityplayer) {
        ...
        if (this.getAmphibianAge() >= 1.0f && !this.isUserRiding() && !this.worldObj.isRemote && (this.riddenByEntity == null || this.riddenByEntity == entityplayer)) {
