...
public abstract class EntityTropicraftWaterMob extends EntityWaterMob
{
    ...
    public void onLivingUpdate() {
        ...
        if (!this.isInWater()) {
            ...
            final Block blockUnder = this.worldObj.getBlock(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.posY - 1.0), MathHelper.floor_double(this.posZ));
            final Block blockAt = this.worldObj.getBlock(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.posY), MathHelper.floor_double(this.posZ));
    ...
    protected void updateEntityActionState() {
        ++this.entityAge;
        if (this.targetEntity != null) {
            if (this.targetEntity.isDead || !this.targetEntity.isInWater() || this.getDistanceToEntity(this.targetEntity) > 10.0f) {
        ...
        if (this.targetEntity == null) {
            ...
            if (this.rand.nextInt(this.hyperness) == 0 || !this.inWater || (this.randomMotionVecX == 0.0f && this.randomMotionVecY == 0.0f && this.randomMotionVecZ == 0.0f)) {
    ...
    protected int getDistanceToSurface(final int i) {
        if (this.worldObj.getBlock(MathHelper.floor_double(this.posX), (int)this.posY + i, MathHelper.floor_double(this.posZ)).getMaterial().isLiquid()) {
    ...
    public void applyEntityCollision(final Entity entity) {
        ...
        if (this.targetEntity != null && entity.equals((Object)this.targetEntity) && this.attackStrength() != 0) {
            this.targetEntity.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this), (float)this.attackStrength());
            this.attackTime = 60;
        }
    }
    ...
    public void fishDebug(final String s) {
        try {
            if (EntityTropicraftWaterMob.fishingDebug && !this.worldObj.isRemote) {
                final String out = "<" + this.getEntityString().split("\\.")[1] + this.getEntityId() + ">: " + s;
    ...
    public void faceEntity(final EntityLivingBase entSource, final Entity par1Entity, final float par2, final float par3) {
        ...
        if (par1Entity instanceof EntityLivingBase) {
            ...
            d3 = (par1Entity.boundingBox.minY + par1Entity.boundingBox.maxY) / 2.0 - (entSource.posY + entSource.getEyeHeight());
        }
        final double d4 = MathHelper.sqrt_double(d0 * d0 + d2 * d2);
        final float f2 = (float)(Math.atan2(d2, d0) * 180.0 / 3.141592653589793) - 90.0f;
        final float f3 = (float)(-(Math.atan2(d3, d4) * 180.0 / 3.141592653589793));
