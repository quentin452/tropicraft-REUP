...
public class JobFish extends JobBase
{
    ...
    public void tick() {
        ...
        if (this.ai.entInv != null && this.getFishEntity() != null && (this.state == EnumJobState.IDLE || this.getFishEntity().isDead)) {
            this.getFishEntity().setDead();
            this.getFishEntity().catchFish();
        ...
        if (this.state == EnumJobState.IDLE) {
            ...
            else if (rand.nextInt(150) == 0 && this.ent.getNavigator().noPath()) {
            ...
            if (!this.ent.isInWater()) {
                if (this.walkingTimeout <= 0 || this.ent.getNavigator().noPath()) {
                    final float tdist = (float)this.ent.getDistance((double)this.ai.targX, (double)this.ai.targY, (double)this.ai.targZ);
            ...
            if (this.ent.getDistance((double)this.ai.targX, (double)this.ai.targY, (double)this.ai.targZ) < 8.0 || this.ent.isInWater() || test) {
                if (CoroUtilEntity.canCoordBeSeenFromFeet((EntityLivingBase)this.ent, this.ai.targX, this.ai.targY, this.ai.targZ) || test) {
            ...
            if (this.getFishEntity() == null || this.fishingTimeout <= 0 || (this.getFishEntity() != null && (this.getFishEntity().inGround || (this.getFishEntity().ticksCatchable > 0 && this.getFishEntity().ticksCatchable < 10)))) {
                if (this.getFishEntity() != null) {
                    this.catchFish();
                }
            ...
            if (this.walkingTimeout <= 0 || (this.ent.getNavigator().noPath() && this.ent.worldObj.getWorldTime() % 20L == 0L)) {
                this.ai.walkTo((Entity)this.ent, this.ai.homeX, this.ai.homeY, this.ai.homeZ, (float)this.pfRangeHome, 600);
            }
            ...
            if (this.ent.getDistance((double)this.dryCastX, this.ent.posY, (double)this.dryCastZ) < 5.0 || this.ent.onGround) {
            ...
            if (this.walkingTimeout <= 0 || (this.ent.getNavigator().noPath() && this.ent.worldObj.getWorldTime() % 20L == 0L)) {
                if (this.ent.getDistance((double)this.dryCastX, (double)this.dryCastY, (double)this.dryCastZ) < 64.0) {
    ...
    protected void castLine() {
        ...
        final double dist = this.ent.getDistance((double)this.ai.targX, (double)this.ai.targY, (double)this.ai.targZ);
    ...
    protected int getFishCount() {
        int count = 0;
        count += CoroUtilInventory.getItemCount((IInventory)this.ai.entInv.inventory, Item.itemRegistry.getNameForObject((Object)Items.fish));
        count += CoroUtilInventory.getItemCount((IInventory)this.ai.entInv.inventory, Item.itemRegistry.getNameForObject((Object)TCItemRegistry.freshMarlin));
        return count;
    }
    ...
    public void tossItems() {
        for (int j = 0; j < this.ai.entInv.inventory.invList.length; ++j) {
            if (this.ai.entInv.inventory.invList[j] != null && this.isFish(this.ai.entInv.inventory.invList[j].getItem())) {
