...
public class EntityChair extends Entity
{
    ...
    public EntityChair(final World world, final double x, final double y, final double z, final int color, final EntityPlayer player) {
        this(world);
    ...
    public void onUpdate() {
        ...
        if (this.worldObj.isRemote && this.isChairEmpty) {
            if (this.chairPosRotationIncrements > 0) {
                ...
                this.rotationPitch += (float)((this.chairPitch - this.rotationPitch) / this.chairPosRotationIncrements);
            ...
            if (!this.worldObj.isRemote) {
                final List<?> list = (List<?>)this.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this, this.boundingBox.expand(0.20000000298023224, 0.0, 0.20000000298023224));
    ...
    protected void updateFallState(final double distanceFallenThisTick, final boolean onGround) {
        ...
        if (onGround) {
            if (this.fallDistance > 3.0f) {
                ...
                if (!this.worldObj.isRemote && !this.isDead) {
                    this.setDead();
                    for (int l = 0; l < 3; ++l) {
                        this.entityDropItem(new ItemStack(Item.getItemFromBlock(Blocks.wool), 1, this.getDamageFromColor()), 0.0f);
                    }
        ...
        else if (this.worldObj.getBlock(i, j - 1, k).getMaterial() != Material.water && distanceFallenThisTick < 0.0) {
    ...
    public void setComeSailAway(final boolean sail) {
        this.dataWatcher.updateObject(4, (Object)(sail ? 1 : ((Byte)0)));
    }
