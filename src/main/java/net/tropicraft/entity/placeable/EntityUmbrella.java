...
public class EntityUmbrella extends Entity
{
    ...
    public void onUpdate() {
        ...
        final List<?> list = (List<?>)this.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this, this.boundingBox.expand(0.20000000298023224, 0.2, 0.20000000298023224));
    ...
    public boolean attackEntityFrom(final DamageSource damagesource, final float i) {
        ...
        if (!this.worldObj.isRemote && !this.isDead) {
            ...
            final boolean flag = damagesource.getEntity() instanceof EntityPlayer && ((EntityPlayer)damagesource.getEntity()).capabilities.isCreativeMode;
            if (flag || this.getDamage() > 40.0f) {
                if (this.riddenByEntity != null) {
                    this.riddenByEntity.mountEntity((Entity)this);
                }
                if (!flag) {
                    this.entityDropItem(new ItemStack((Item)TCItemRegistry.umbrella, 1, this.getDamageFromColor()), 0.0f);
                }
                this.setDead();
